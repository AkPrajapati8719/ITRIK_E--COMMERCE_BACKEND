...
def home(request):
    ...
    """
    # 🔥 FIX: Added 'frontend_Itrik_code' to the path
...
if settings.DEBUG:
    ...
    # 🔥 FIX: Point to the images folder inside frontend_Itrik_code
    ...
    # 🔥 FIX: Point to the static folder (JS/CSS) inside frontend_Itrik_code
